...
export const attackFacetAbi = [
  {
    ...
    inputs: [
      ...
      { name: "_numVillagersRaidWood", internalType: "uint16", type: "uint16" },
      { name: "_numVillagersRaidFood", internalType: "uint16", type: "uint16" },
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        name: "numVillagersRaidWood",
        internalType: "uint16",
        type: "uint16",
        indexed: false,
      },
      {
        name: "numVillagersRaidFood",
        internalType: "uint16",
        type: "uint16",
        indexed: false,
      },
    ],
    name: "AttackVillageV2",
  },
  {
    type: "event",
    anonymous: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        name: "woodWinnerVillageIds",
        internalType: "uint256[]",
        type: "uint256[]",
        indexed: false,
      },
      {
        name: "foodWinnerVillageIds",
        internalType: "uint256[]",
        type: "uint256[]",
        indexed: false,
      },
    ...
    name: "RevealBattleResultV2",
  },
  { type: "error", inputs: [], name: "AttackTimeHasNotPassed" },
  { type: "error", inputs: [], name: "CantRaidWithBothNoVillagers" },
  { type: "error", inputs: [], name: "NotEnoughVillagersSentForNoDefense" },
  ...
  { type: "error", inputs: [], name: "VillageLevelTooHighForBattle" },
  { type: "error", inputs: [], name: "VillageLevelTooLowForBattle" },
  {
    type: "error",
...
export const defendFacetAbi = [
  ...
  },
  {
    ...
    inputs: [
      { name: "_tokenId", internalType: "uint256", type: "uint256" },
      {
        name: "_numVillagersDefendWood",
        internalType: "uint16",
        type: "uint16",
      },
      {
        name: "_numVillagersDefendFood",
        internalType: "uint16",
        type: "uint16",
      },
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        name: "numVillagersDefending",
        internalType: "uint16",
        type: "uint16",
        indexed: false,
      },
    ],
    name: "CommitDefenseV2",
  },
  {
    type: "event",
    anonymous: false,
    ...
    outputs: [
      {
        ...
        components: [
          ...
          {
            name: "villagersRaiding",
            internalType: "uint256",
            type: "uint256",
          },
          {
            name: "villagersDefending",
            internalType: "uint256",
            type: "uint256",
          },
        ],
